...
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33}  [ get_ports "fpga_tx" ]
#set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33}  [ get_ports "pmodb[4]" ]

# set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33}  [ get_ports "fpga_rx" ]
...
# set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33}  [ get_ports "fpga_rx" ]

set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33}  [ get_ports "fpga_rx" ]
